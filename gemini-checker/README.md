...
### 默认版本 (`gemini_checker.sgmodule`)
- 检测名为 **"Gemini"** 的策略组
- 推荐配合独立的Gemini策略组使用
- 适合大多数用户

### 美国策略组版本 (`gemini_checker_usa.sgmodule`)
- 检测名为 **"美国手动"** 的策略组
- 适合直接检测现有美国节点
- 无需创建新策略组

**💡 配置示例:** 查看 [`surge_config_example.md`](surge_config_example.md) 了解如何配置Surge策略组。
...
### v1.1.0 (2026-01-06)
- ✨ 新增美国策略组专用版本 (`gemini_checker_usa.sgmodule`)
- 📝 添加详细的Surge配置示例文档
- 📚 更新使用指南,说明两个版本的区别
